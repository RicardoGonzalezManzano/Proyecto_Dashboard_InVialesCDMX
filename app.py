...
=================================================================
Tablero construido con Streamlit + Plotly.
...
PAGINAS = {
    ...
    "dataset":     ("", "Los datos",    "De dónde salen los datos y explorar los registros"),
}
...
def pagina_inicio(df: pd.DataFrame) -> None:
    ...
    st.markdown(
        "Bienvenida/o. Este tablero analiza **503,339 incidentes viales**, del periodo de Enero 2022 a Febrero 2024, "
...
def barra_lateral() -> None:
    ...
    with st.sidebar:
        ...
        with st.expander(" ¿Cómo usar este tablero?"):
            st.markdown(
                "1. Selecciona una sección de este menú o las tarjetas del inicio.\n"
        ...
        st.divider()
        st.caption("Datos abiertos: C5 CDMX")
